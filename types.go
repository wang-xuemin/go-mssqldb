...
import (
	...
	"github.com/wang-xuemin/go-mssqldb/internal/cp"
	"github.com/wang-xuemin/go-mssqldb/internal/decimal"
)
...
func readShortLenType(ti *typeInfo, r *tdsBuffer, cryptoMetadata *cryptoMetadata) interface{} {
	var size uint16
